<template>
    <div>
		...
		>
			...
			<el-table-column prop="name" label="规格名称" width="380px">
		...
		<el-dialog v-model='createModel' :title="editIndex ? '创建规格' : '修改规格'">
			<el-form :model="form" ref="formRef"  :rules="rules">
				<el-form-item label="名称" prop="name">
					<el-input v-model="form.name" placeholder="规格名称" style="width:40%;"></el-input>
				</el-form-item>
